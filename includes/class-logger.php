...
class FEU_Einsatz_Logger {
    ...
    private function get_log_detail_label($key) {
        $labels = [
            ...
            'categories' => __('Kategorien', 'feuer-einsatzberichte'),
            'selected_categories' => __('Kategorien', 'feuer-einsatzberichte'),
            ...
            'summary.terms' => __('Kategorien', 'feuer-einsatzberichte'),
