...
<article class="card mb-4 shadow-sm overflow-hidden feu-einsatz-report-card feu-einsatz-report-card-magazine feu-einsatz-report-card-magazine-left">
    <div class="row g-0">
        ...
        <div class="<?php echo !empty($report['image_url']) ? 'col-lg-7 order-2 order-lg-2' : 'col-12'; ?>">
